...
class SqrtX {
    public int mySqrt(int x) {
        ...
        // 1. Use of long to ensure no integer overflow during computation.
        long left = 1;
        ...
        while (left <= right) {
            ...
            // 4. Obtain exact answer of sqrt(x).
            if (mid * mid == x) {
                return (int) mid;

            /**
                5.  Obtain floor of sqrt(x)
            ...
            */
                ...
                // 6. mid > sqrt(x), so exclude all values from right onwards.
            } else {
                right = mid - 1;
            }
        }
